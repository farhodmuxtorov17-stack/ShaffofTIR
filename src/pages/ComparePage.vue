...
const L = computed(() => locale.value === 'uz' ? {
  title: 'Taqqoslash',
  subtitle: 'Suratga olish → система tahlil → Protokol',
  back: 'Natijalar',
  ...
  step3: '3-bosqich: система tahlil',
  step3Desc: 'Sun\'iy intellekt o\'q teshiklarini aniqlaydi',
  step3Btn: 'система tahlilni boshlash',
  ...
  after: 'Keyin (Keyin)',
  analyzing: 'система tahlil qilmoqda...',
  analyzingDesc: 'ShaffofTIR система rasmdan o\'q teshiklarini aniqlamoqda',
  hits: 'Tekkan',
  misses: 'Tegmagan',
  ...
  needAnalysis: 'Avval система tahlilni bajaring',
  next: 'Keyingi',
  prev: 'Oldingi',
} : {
  title: 'Сравнение',
  ...
  analyzingDesc: 'ShaffofTIR система обнаруживает отверстия от пуль',
  hits: 'Попаданий',
  misses: 'Промахов',
