...
const routes = [
  ...
  { path: "/cameras/config", name: "CameraConfig", component: () => import("@/pages/CameraConfigPage.vue") },
...
const routeRoles: Record<string, string[]> = {
  ...
  '/review': ['INSTRUCTOR'],
  '/cameras': ['INSTRUCTOR', 'TECHSPEC'],
  '/hr': ['SUPER_ADMIN'],
  '/weapons': ['INSTRUCTOR'],
  '/training/materials': ['SUPER_ADMIN', 'MANAGER', 'INSTRUCTOR', 'EMPLOYEE'],
  '/training/schedule': ['INSTRUCTOR', 'EMPLOYEE'],
  '/training/history': ['INSTRUCTOR', 'EMPLOYEE'],
  '/training': ['SUPER_ADMIN', 'MANAGER', 'INSTRUCTOR', 'EMPLOYEE'],
  ...
  '/recommendations': ['SUPER_ADMIN', 'EMPLOYEE'],
  '/action-plans': ['SUPER_ADMIN'],
  '/command-center': ['SUPER_ADMIN', 'MANAGER'],
  '/org-structure': ['SUPER_ADMIN'],
