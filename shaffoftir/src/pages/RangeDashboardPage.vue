...
const L = computed(() => ({
  title: locale.value === 'uz' ? "Oʻq otish tiri" : 'Огневой тир',
  subtitle: locale.value === 'uz' ? "Yoʻlaklar holati va jonli efir" : 'Состояние дорожек и живой эфир',
  settings: locale.value === 'uz' ? 'Sozlash' : 'Созлаш',
  newSession: locale.value === 'uz' ? 'Yangi sessiya' : 'Новая сессия',
  activeLanes: locale.value === 'uz' ? "Faol yoʻlak" : 'Активн. дорож.',
  of: locale.value === 'uz' ? 'dan' : 'дан',
  totalShots: locale.value === 'uz' ? "Jami oʻq" : 'Всего выстр.',
  ...
  shots: locale.value === 'uz' ? "oʻq" : 'выстр.',
